...
A search engine optimized, mobile-first, flexbox-based starter theme for the Genesis Framework with development automation tools. Demo - [https://demo.seothemes.com/rivers-lawn](https://demo.seothemes.com/rivers-lawn)
...
2. Upload, install and activate Rivers Lawn
...
1. Search and replace `rivers-lawn` with your theme text domain.
2. Search and replace `riverslawn_` with your theme function prefix.
3. Search and replace `Rivers Lawn` with your theme name.
...
Rivers Lawn uses [Gulp](http://gulpjs.com/) as a build tool and [npm](https://www.npmjs.com/) to manage front-end packages.
...
See also the list of [contributors](https://github.com/seothemes/rivers-lawn/graphs/contributors) who participated in this project.
