 ...
 *
 * This file adds the landing page template to the Rivers Lawn Theme.
 *
 * @package   StudioPro
...
add_filter( 'body_class', 'riverslawn_landing_page_body_class' );
/**
 ...
 */
function riverslawn_landing_page_body_class( $classes ) {
...
add_action( 'wp_enqueue_scripts', 'riverslawn_dequeue_skip_links' );
/**
 * Dequeue Skip Links Script.
 *
 * @return void
 */
function riverslawn_dequeue_skip_links() {

	wp_dequeue_script( 'skip-links' );

}

add_action( 'genesis_before', 'riverslawn_landing_page_title', 99 );
/**
 ...
 * @return void
 */
function riverslawn_landing_page_title() {
