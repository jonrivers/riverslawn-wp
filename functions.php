 ...
 * Rivers Lawn Theme
 *
 * This file adds basic functionality to the Rivers Lawn theme.
 *
 * @package   StudioPro
...
define( 'CHILD_THEME_NAME', 'Rivers Lawn' );
define( 'CHILD_THEME_URL', 'https://seothemes.com/themes/rivers-lawn' );
define( 'CHILD_THEME_VERSION', '2.2.2' );

// Set Localization (do not remove).
load_child_theme_textdomain( 'rivers-lawn', apply_filters( 'child_theme_textdomain', get_stylesheet_directory() . '/languages', 'rivers-lawn' ) );
...
add_theme_support( 'genesis-menus' , array(
	'primary' => __( 'Header Menu', 'rivers-lawn' ),
) );
...
add_theme_support( 'custom-header', array(
	...
	'uploads'            => true,
	'video'              => true,
	'wp-head-callback'   => 'riverslawn_custom_header',
) );
...
add_action( 'wp_enqueue_scripts', 'riverslawn_scripts_styles', 98 );
/**
 * Enqueue theme scripts and styles.
 *
 * @return void
 */
function riverslawn_scripts_styles() {
	...
	if ( riverslawn_is_woocommerce_page() ) {

		wp_enqueue_style( 'rivers-lawn-woocommerce', get_stylesheet_directory_uri() . '/assets/styles/min/woocommerce.min.css', array(), CHILD_THEME_VERSION );
	...
	wp_enqueue_script( 'rivers-lawn', get_stylesheet_directory_uri() . '/assets/scripts/' . $folder . 'scripts.' . $suffix . 'js', array( 'jquery' ), CHILD_THEME_VERSION, true );

	// Localize responsive menu script.
	wp_localize_script( 'rivers-lawn', 'genesis_responsive_menu', array(
		'mainMenu'         => __( 'Menu', 'rivers-lawn' ),
		'subMenu'          => __( 'Menu', 'rivers-lawn' ),
		'menuIconClass'    => null,
