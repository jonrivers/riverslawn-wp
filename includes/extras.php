 ...
 * Rivers Lawn Theme
 *
 * This file adds extra functions used in the Rivers Lawn Theme.
 *
 * @package   StudioPro
...
add_filter( 'body_class', 'riverslawn_body_class' );
/**
 ...
 * @return array
 */
function riverslawn_body_class( $classes ) {

	if ( get_theme_mod( 'riverslawn_sticky_header', false ) === true ) {
	...
	if ( get_theme_mod( 'riverslawn_blog_layout', 'masonry' ) === 'masonry' && is_home() || is_search() || is_archive() || is_page_template( 'page_blog.php' ) && ! is_post_type_archive() && ! is_tax() ) {
...
add_action( 'genesis_before', 'riverslawn_js_nojs_script', 1 );
/**
 ...
 * @return void
 */
function riverslawn_js_nojs_script() {
...
add_filter( 'genesis_attr_title-area', 'riverslawn_title_area_schema' );
/**
 ...
 * @return array
 */
function riverslawn_title_area_schema( $attr ) {
...
add_filter( 'genesis_attr_site-title', 'riverslawn_site_title_schema' );
/**
 ...
 * @return array
 */
function riverslawn_site_title_schema( $attr ) {
...
add_action( 'genesis_admin_before_metaboxes', 'riverslawn_remove_metaboxes' );
/**
 ...
 * @return void
 */
function riverslawn_remove_metaboxes( $hook ) {

	remove_meta_box( 'genesis-theme-settings-nav', $hook, 'main' );

}

add_action( 'genesis_entry_header', 'riverslawn_display_featured_image' );
/**
 ...
 * @return void
 */
function riverslawn_display_featured_image() {
...
add_action( 'genesis_entry_footer', 'riverslawn_single_cpt_pagination' );
/**
 ...
 * @return void
 */
function riverslawn_single_cpt_pagination() {
...
add_action( 'genesis_before', 'riverslawn_narrow_content_layout' );
/**
 ...
 * @return string
 */
function riverslawn_narrow_content_layout() {
...
add_filter( 'genesis_site_layout', 'riverslawn_page_template_layout' );
/**
 ...
 * @return string
 */
function riverslawn_page_template_layout() {
...
add_action( 'genesis_entry_header', 'riverslawn_reposition_post_meta', 0 );
/**
 ...
 * @return void
 */
function riverslawn_reposition_post_meta() {
...
add_filter( 'genesis_post_info', 'riverslawn_post_info_date' );
/**
 ...
 * the riverslawn_reposition_post_meta() function above on archive pages.
 *
 * @since  0.1.0
 *
 ...
 * @return string
 */
function riverslawn_post_info_date( $post_info ) {
...
add_action( 'wp_head', 'riverslawn_remove_ssi_inline_styles', 1 );
/**
 ...
 * @return void
 */
function riverslawn_remove_ssi_inline_styles() {
...
add_action( 'wp_head', 'riverslawn_simple_social_icons_css' );
/**
 ...
 * @return void
 */
function riverslawn_simple_social_icons_css() {
...
add_action( 'init', 'riverslawn_structural_wrap_hooks' );
/**
 ...
 * @return void
 */
function riverslawn_structural_wrap_hooks() {
...
add_filter( 'genesis_markup_title-area_close', 'riverslawn_after_title_area', 10, 2 );
/**
 ...
 * @return string
 */
function riverslawn_after_title_area( $close_html, $args ) {
...
add_filter( 'http_request_args', 'riverslawn_dont_update_theme', 5, 2 );
/**
 * Don't Update Theme.
 *
 ...
 */
function riverslawn_dont_update_theme( $request, $url ) {
