 ...
 * Rivers Lawn Theme
 *
 * This file registers the default settings for the Rivers Lawn theme.
 *
 * @package   StudioPro
...
add_filter( 'genesis_theme_settings_defaults', 'riverslawn_theme_defaults' );
/**
 ...
 */
function riverslawn_theme_defaults( $defaults ) {
...
add_action( 'after_switch_theme', 'riverslawn_theme_setting_defaults' );
/**
 ...
 * @return void
 */
function riverslawn_theme_setting_defaults() {
...
add_filter( 'simple_social_default_styles', 'riverslawn_social_default_styles' );
/**
 * Rivers Lawn Simple Social Icon Defaults.
 *
 * @since  2.0.0
 * 
 ...
 */
function riverslawn_social_default_styles( $defaults ) {
...
add_filter( 'icon_widget_default_font', 'riverslawn_icon_widget_default_font' );
/**
 ...
 * @return string
 */
function riverslawn_icon_widget_default_font() {

	return 'streamline';

}

add_filter( 'icon_widget_default_color', 'riverslawn_icon_widget_default_color' );
/**
 * Set the default icon widget font.
 *
 * @since  2.2.1
 ...
 * @return string
 */
function riverslawn_icon_widget_default_color() {

	return '#1885ec';

}

add_filter( 'icon_widget_default_size', 'riverslawn_icon_widget_default_size' );
/**
 * Set the default icon widget font.
 *
 * @since  2.2.1
 ...
 * @return string
 */
function riverslawn_icon_widget_default_size() {

	return '3x';

}

add_filter( 'icon_widget_default_align', 'riverslawn_icon_widget_default_align' );
/**
 * Set the default icon widget font.
 *
 * @since  2.2.1
 ...
 * @return string
 */
function riverslawn_icon_widget_default_align() {

	return 'center';

}

add_action( 'after_switch_theme', 'riverslawn_excerpt_metabox' );
/**
 * Display excerpt metabox by default.
 *
 * Rivers Lawn adds support for excerpts on pages to be used as subtitles on the
 ...
 * @return void
 */
function riverslawn_excerpt_metabox() {
...
add_filter( 'pt-ocdi/import_files', 'riverslawn_demo_import' );
/**
 ...
 * @return array
 */
function riverslawn_demo_import() {
...
add_filter( 'pt-ocdi/after_all_import_execution', 'riverslawn_after_demo_import', 999 );
/**
 ...
 * @since  2.2.0
 *
 * @uses   riverslawn_slug_exists Helper function.
 *
 * @return void
 */
function riverslawn_after_demo_import() {
